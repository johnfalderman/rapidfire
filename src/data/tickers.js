...
// The index technically contains 101 rows because Alphabet has two share
// classes — we keep both so the list matches the official membership.
export const tickers = [
  ...
  { symbol: 'MDLZ',  name: 'Mondelēz International',        sector: 'Consumer Staples' },
